...
internal class AdventureParserTest {
    ...
    internal fun `should properly parse sample adventure root directory`() {
        ...
        assertThat(adventure.startingLocationId).isEqualTo("starting_hall")
        assertThat(adventure.staringLocation.description).isEqualTo(adventure.findLocation("starting_hall")?.description)

        assertThat(adventure.getAllLocations()).size().isEqualTo(3)
        assertThat(adventure.getAllLocations().keys).containsExactlyInAnyOrder("corridor_left", "corridor_right", "starting_hall")
    ...
    internal fun `should properly parse corridor_left location`() {
        ...
        val corridorLeftLocation = adventure.findLocation("corridor_left")
        ...
        assertThat(corridorLeftLocation.passages.getAll()).size().isEqualTo(1)

        val passageToStartingHall = corridorLeftLocation.passages.findByLabel("back to hall")
    ...
    internal fun `should properly parse corridor_right location`() {
        ...
        val corridorRightLocation = adventure.findLocation("corridor_right")
        ...
        assertThat(corridorRightLocation.passages.getAll()).size().isEqualTo(1)

        val passageToStartingHall = corridorRightLocation.passages.findByLabel("back to hall")
        assertThat(passageToStartingHall?.label).isEqualTo("back to hall")
        assertThat(passageToStartingHall?.targetLocationId).isEqualTo("starting_hall")
    }
    ...
    internal fun `should properly parse starting_hall location`() {
        ...
        val startingHallLocation = adventure.findLocation("starting_hall")
        ...
        assertThat(startingHallLocation.passages.getAll()).size().isEqualTo(2)

        val passageToLeftCorridor = startingHallLocation.passages.findByLabel("left door")
        ...
        val passageToRightCorridor = startingHallLocation.passages.findByLabel("right door")
